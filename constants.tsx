...
// Using a simple placeholder for icons to keep file count low, 
// usually we'd import from lucide-react. 
// I will create simple SVG components here to avoid external dependency complexity in this prompt format.
...
export const IconClapperboard = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M20.2 6 3 11l-.9-2.4c-.5-1.1.2-2.4 1.3-2.9L13.2 2c1.1-.5 2.4.2 2.9 1.3l4.1 2.7c1.1.5.5 2.4-.6 2.8Z"/><path d="m22 22-2-10-16.5 1.6c-1.1.1-1.9 1-1.8 2.1l1.2 12.1c.1 1.2 1.1 2.1 2.3 2.1h16.8c1.2 0 2.2-1 2-2.2Z"/></svg>
);
